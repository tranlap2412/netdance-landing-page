              ...
              <div className="border-b border-gray-200">
                ...
                >
                  ...
                  <div className="w-full lg:w-1/6 self-center text-xs px-3">
                    <a
                      className="block mb-2 py-4 text-center hover:text-white font-semibold bg-blueGray-200 hover:bg-blue-500 rounded"
                      href="#"
                    >
                      Buy 25$
                    </a>
          ...
          <div className="container mx-auto">
            <div className="max-w-2xl lg:max-w-3xl mx-auto">
              <div className="mb-12 text-center">
                ...
                <p
                  className="text-blueGray-400 wow animate__animatedanimated animate__fadeIn animated"
                  data-wow-delay=".5s"
                >
