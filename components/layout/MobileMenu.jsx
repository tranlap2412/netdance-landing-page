...
const MobileMenu = ({ hiddenClass, handleRemove }) => {
  ...
  return (
    <>
      <div
        className={`${hiddenClass} navbar-menu relative z-50 transition duration-500`}
      >
        <div className="navbar-backdrop fixed inset-0 bg-blueGray-800 opacity-25"></div>
        <nav className="fixed z-30 top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto transition duration-300">
