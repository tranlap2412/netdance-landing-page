    ...
    <>
      <section className="py-20">
        <div
          ...
          data-wow-delay=".3s"
        >
          <div className="flex flex-wrap mb-12 lg:mb-10 -mx-3 text-center lg:text-left">
            ...
            <div className="lg:w-9/12 px-3 mb-8 lg:mb-0">
              <Link href="/">
                <a className="w-full mx-auto lg:mx-0 text-3xl font-semibold leading-none">
                  <img
                    className=" pb-5"
                    src="/assets/imgs/logos/bannerFooter.png"
                    alt="NetDance"
                  />
                </a>
              </Link>
              <div className="flex flex-col lg:flex-row ">
                <div className="lg:w-7/12 px-3 mb-8 lg:mb-0">
                  ...
                  <p className="max-w-md mx-auto lg:max-w-full lg:mx-0 lg:pr-32 lg:text-md text-blueGray-400 leading-relaxed">
                    <strong>Company</strong> : BITDANCE Technology and
                  ...
                  <p className="max-w-md mx-auto lg:max-w-full lg:mx-0 lg:pr-32 lg:text-md text-blueGray-400 leading-relaxed">
                    <strong>Transaction point</strong> : 391 Su Van Hanh, Ward
